...
[ub1,sigmab1,pib1]=EMN(bg,1);
[ub2,sigmab2,pib2]=EMN(bg,2);
[ub3,sigmab3,pib3]=EMN(bg,4);
[ub4,sigmab4,pib4]=EMN(bg,8);
[ub5,sigmab5,pib5]=EMN(bg,16);
[ub6,sigmab6,pib6]=EMN(bg,32);
[uf1,sigmaf1,pif1]=EMN(fg,1);
[uf2,sigmaf2,pif2]=EMN(fg,2);
[uf3,sigmaf3,pif3]=EMN(fg,4);
[uf4,sigmaf4,pif4]=EMN(fg,8);
[uf5,sigmaf5,pif5]=EMN(fg,16);
[uf6,sigmaf6,pif6]=EMN(fg,32);
